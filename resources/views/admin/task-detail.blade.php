        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('taskitem', ['task_id' => $task->id]) }}">{{$task->id}}</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-footer bg-white">
                    <div class="row">
                        ...
                        <div class="btn-group" style="margin-left: 20px;">
                            <a href="{{route('taskitem.add', ['task_id' => $task->id])}}" class="btn btn-default btn-sm"><i class="fas fa-plus"></i></a>
                          </div>
                    </div>
