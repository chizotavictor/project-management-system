...
<head>
    ...
    <style>
        ...
        * {
        ...
        .email-wraper a { color: #007bff; word-break: break-all; }
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            <a href="/">
                                <h1 style="text-align: center; color: #000000">Gamint</h1>
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding:25px 20px 0;">
                            <p style="font-size: 13px;">Copyright © {{ date('Y') - 2 }} Gamint. All rights reserved. .</p>
                            <p style="padding-top: 15px; font-size: 12px;">
                                This email was sent to you as a registered user of
                                <a style="color: #007bff; text-decoration:none;" href="/">gamint.com</a>.
                                To update your emails preferences <a style="color: #007bff; text-decoration:none;" href="#">click here</a>.
                            </p>
                        </td>
                    </tr>
                    </tbody>
